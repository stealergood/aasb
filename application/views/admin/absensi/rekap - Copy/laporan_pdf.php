    ...
    <table id="table">
        ...
        <tbody>
            ...
            foreach ($dataku as $data) {
                ...
                echo '<tr><td style="text-align:center;">' . $no . '</td><td style="text-align:right;">' . $data->nis_siswa . '</td><td>' . $data->name . '</td><td style="text-align:center;">' . $jk . '</td><td style="text-align:center;">' . $data->tanggal . '</td><td>' . $data->nama_mapel . '</td><td style="text-align:center;">' . $data->pertemuan_ke . '</td><td style="text-align:center;">' . $data->jam . '</td><td style="text-align:center;">' . $data->keterangan . '</tr>';
                $no++;
            }
            ?>
        </tbody>
