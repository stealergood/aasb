    ...
    <table id="table">
        ...
        -->
            ...
            foreach ($dataku as $data) {
                ...
                echo '<tr><td style="text-align:center;">' . $no . '</td><td style="text-align:right;">' . $data->nis_siswa . '</td><td>' . $data->name . '</td><td>' . $data->nama_orangtua . '</td><td style="text-align:center;">' . $jk . '</td><td style="text-align:center;">' . $data->tanggal . '</td><td>' . $data->nama_kelas . '</td><td style="text-align:center;">' . $data->keterangan . '</tr>';
                $no++;
            }
            ?>
