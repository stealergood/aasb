<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?= base_url($this->session->userdata('jenis_login')) ?>/home">
    ...
    <!--    <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#absensi-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-menu-button-wide"></i><span>Laporan Presensi</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
