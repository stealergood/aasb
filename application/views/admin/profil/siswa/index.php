                ...
                <div class="tab-content pt-2">
                    ...
                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-9 col-md-8"><?= $data['nis_siswa'] ?></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-8"><?= $data['nama_kelas'] ?></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-8"><?= $data['tahun_masuk'] ?></div>
                        </div>
                        ...
                        <form>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input type="hidden" class="form-control" id="id" name="id" value="<?= $data['id_siswa'] ?>">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <select class="form-select" aria-label="Default select" name="kelas" id="kelas">
                                        ...
                                        foreach ($data_kelas as $kelas) {
                                            echo '<option value="' . $kelas->id_kelas . '" ';
                                            if ($data['kelas'] == $kelas->id_kelas) {
                                                echo ' selected';
                                            }
                                            echo '>' . $kelas->nama_kelas . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="row mb-3">
                                <label for="tahun_masuk" class="col-md-4 col-lg-3 col-form-label">Tahun Masuk</label>
                                <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control" id="tahun_masuk" name="tahun_masuk" value="<?= $data['tahun_masuk'] ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
