                ...
                <div class="tab-content pt-2">
                    ...
                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-9 col-md-8"><?= $data['nip_kepala_sekolah'] ?></div>
                        </div>
                    ...
                    <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                        ...
                        <form>
                            ...
                            <div class="row mb-3">
                                <label for="nip_kepala_sekolah" class="col-md-4 col-lg-3 col-form-label">NIP Kepala Sekolah</label>
                                <div class="col-md-8 col-lg-9">
                                    <input type="text" class="form-control" id="nip_kepala_sekolah" name="nip_kepala_sekolah" value="<?= $data['nip_kepala_sekolah'] ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                    <small id="nip_kepala_sekolah_help" class="form-text"></small>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <input type="hidden" class="form-control" id="id" name="id" value="<?= $data['id_kepala_sekolah'] ?>">
