...
class Rekap_model extends CI_Model
{
    ...
    {
        $this->db->select('tb_log_absensi.*,tb_siswa.id_siswa,tb_siswa.nis_siswa,tb_siswa.name,tb_siswa.jenis_kelamin,tb_mapel.nama_mapel,tb_kelas.nama_kelas,tb_orang_tua.name as orangtua,tb_orang_tua.email as email_orangtua');
        $this->db->join('tb_siswa', 'tb_siswa.id_siswa = tb_log_absensi.id_siswa', 'left');
        $this->db->join('tb_kelas', 'tb_kelas.id_kelas = tb_log_absensi.id_kelas', 'left');
        $this->db->join('tb_mapel', 'tb_mapel.id_mapel = tb_log_absensi.id_mengajar', 'left');
        $this->db->join('tb_orang_tua', 'tb_orang_tua.email = tb_siswa.email_orangtua', 'left');
