...
class Orang_tua_model extends CI_Model
{
    ...
    var $order = array('id_orang_tua' => 'asc'); // default order 
    ...
    public function cek_username_orang_tua($username = null){
        return $this->db->where('username', $username)->get('tb_orang_tua');
    }

    public function cek_edit_username_orang_tua($username, $id)
    {
    ...
    public function update_orang_tua($data, $id)
    {
        $this->db->where('id_orang_tua', $id);
        $this->db->update('tb_orang_tua', $data);
    }

    public function delete_orang_tua($id)
    {
        $this->db->where('id_orang_tua', $id);
        $this->db->delete('tb_orang_tua');
    }
    public function get_data_ortu()
    {
        return $this->db->get('tb_orang_tua')->result();
    }
}
